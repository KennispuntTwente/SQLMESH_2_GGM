...
def main() -> None:
    ...
    parser.add_argument("--host", default=os.environ.get("ORACLE_HOST", "localhost"))
    parser.add_argument("--port", type=int, default=int(os.environ.get("ORACLE_PORT", "1521")))
    parser.add_argument("--service-name", default=os.environ.get("ORACLE_SERVICE_NAME", "ggm"))
    parser.add_argument("--user", default="appuser")
    parser.add_argument("--password", default="apppass")
